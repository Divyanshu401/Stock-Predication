...
def interactive_plot(df):
    ...
    fig.update_layout(width=450, margin =dict(l=20,r=20,b=20),legend=dict(orientation='h',yanchor='bottom',y=1.02,xanchor='right', x=1))
    return fig 
# function to normalize the prices based on initial prices
def normalize(df_2):
    df = df_2.copy()
    for i in df.columns[1:]:
